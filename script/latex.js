 ...
 */
   var latex_to_js = function (input) {
    ...
    sin = function (input) {
      return trigonometriFramework("sin", input);
    };
  
    tan = function (input) {
      return trigonometriFramework("tan", input);
    };
  
    cos = function (input) {
      return trigonometriFramework("cos", input);
    };
  
    cot = function (input) {
      return trigonometriFramework("cot", input);
    };
  
    csc = function (input) {
      return trigonometriFramework("csc", input);
    };
  
    sec = function (input) {
      return trigonometriFramework("sec", input);
    };
  
    trigonometriFramework = function (func, input) {
      var pat1 = new RegExp(
        "\\\\" +
          func +
          "\\\\left\\(([0-9a-zA-Z\\.\\+\\*\\-\\\\\\(\\)\\/]+)\\\\right\\)"
    ...
    convert_others = function (func, input) {
      ...
      switch (func) {
        ...
        case "cos":
          ...
          break;
        case "cot":
          temp_input = input.match(/\\cot\{.*/)[0];
          func_pos = temp_input.search(/\\cot\{/);
          break;
        case "csc":
          temp_input = input.match(/\\csc\{.*/)[0];
          func_pos = temp_input.search(/\\csc\{/);
          break;
        case "sec":
          temp_input = input.match(/\\sec\{.*/)[0];
          func_pos = temp_input.search(/\\sec\{/);
          break;
        default:
          return;
      }
      ...
      cot_pos = temp_input.search(/\\cot\{/);
      csc_pos = temp_input.search(/\\csc\{/);
      sec_pos = temp_input.search(/\\sec\{/);
